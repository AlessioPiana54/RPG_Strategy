package it.unicam.cs.mpgc.rpg.view;
...
public class ActionBar extends HBox {
  ...
  public ActionBar() {
    ...
    setStyle(
      "-fx-background-color: #0d0d1a; -fx-border-color: #1a1a3e; -fx-border-width: 2 0 0 0;"
    );
    ...
    logScroll.setStyle(
      "-fx-background: #111; -fx-border-color: #333; -fx-border-width: 1;"
    );
